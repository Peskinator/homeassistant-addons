...
# A restored Home Assistant data mount arrives owned by root. SFTPGo must own
# its database, keys, certificates, and uploaded-file tree to resume safely.
chown -R sftpgo:sftpgo "$DATA_ROOT"
...
export SFTPGO_WEBDAVD__BINDINGS__0__PORT="0"
